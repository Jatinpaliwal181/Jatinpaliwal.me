var blur = false,
    ...
    alerter, change, revert, title, isIphone = /(iPhone)/i.test(navigator.userAgent),
...
$(function () {
    ...
    $('.item.goon > button').on('click', function () {
        var c = $(this).hasClass('yes') ? 'yes' : 'no',
            d = $(this).data('show');
